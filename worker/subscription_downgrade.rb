...
class SubscriptionDowngrade
  ...
  def self.perform(params)
    puts params.inspect
    Resque.logger = Logger.new("#{Dir.getwd}/logs/5to3update.log")
    #{"action"=>"downgrade_subscription", "subscription_id"=>"8672750", "product_id"=>"8204555081"}
    ...
    temp_hash = provide_downgrade_product(new_product_id, subscription_id)
    puts temp_hash
    ...
    params = {"subscription_id" => subscription_id, "action" => "downgrade_subscription", "details" => temp_hash   }
