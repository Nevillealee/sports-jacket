...
module BackgroundSubs
    ...
    def get_new_subs_last_hour(params)
        ...
        subscriptions = HTTParty.get("https://api.rechargeapps.com/subscriptions/count?created_at_min=\'#{one_hour_ago_str}\'", :headers => my_header)
            
        my_count = subscriptions['count'].to_i
        puts "We have #{my_count} subscriptions created_at this past hour"
        ...
        puts "All done with last hour's created subscriptions"
        #exit
